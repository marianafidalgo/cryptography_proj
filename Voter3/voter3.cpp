...
int voter() {
	...
	stream_public_Key.open("Voter3_Files/SEAL_public.key", ios::binary);
	...
	ofstream voto("Voter3_Files/vote.txt", ios::binary);
	...
	std::cout << "Formato de votação: ID,candidato1-Nº votos,...,candidatoN-Nº votos\n Exemplo:1,1-2,2-1,3-1\n" << endl;
	cin >> str;
...
int main() {
	...
	system("openssl dgst --sha256 -sign Voter3_Files/Voter_private.key -out Voter3_Files/sign.sha256 Voter3_Files/vote.txt\n");

	system("cp Voter3_Files/Voter_cert.crt Voter3_Files/voter_cert.crt \n");

	system("mv Voter3_Files/vote.txt ../Ballot \n");
	sleep( 1 );
	system("mv Voter3_Files/sign.sha256 ../Ballot \n");
	sleep( 1 );
	system("mv Voter3_Files/voter_cert.crt ../Ballot \n");
