...
int voter() {
	...
	stream_public_Key.open("Voter2_Files/SEAL_public.key", ios::binary);
	...
	ofstream voto("Voter2_Files/vote.txt", ios::binary);
...
int main() {
	...
	system("openssl dgst --sha256 -sign Voter2_Files/Voter_private.key -out Voter2_Files/sign.sha256 Voter2_Files/vote.txt\n");

	system("cp Voter2_Files/Voter_cert.crt Voter2_Files/voter_cert.crt \n");

	system("mv Voter2_Files/vote.txt ../Ballot \n");
	sleep( 1 );
	system("mv Voter2_Files/sign.sha256 ../Ballot \n");
	sleep( 1 );
	system("mv Voter2_Files/voter_cert.crt ../Ballot \n");
